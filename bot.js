...
async function startBixbyMD() {
    ...
    // Get Profile Picture Group
       ...
       BixbyMD.send5ButImg(pea[0].id, `*GROUP SETTING CHANGED*\n\n🚀. The Group Has Been Closed By Admin, Now Only Admin Can Send Messages !`, `ʏᴏꜱʜɪᴛʜᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`, lolXeon, [])
       } else if(pea[0].announce == false) {
       BixbyMD.send5ButImg(pea[0].id, `*GROUP SETTING CHANGED*\n\n🚀. The Group Has Been Opened By Admin, Now Participants Can Send Messages !`, `ʏᴏꜱʜɪᴛʜᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`, lolXeon, [])
       } else if (pea[0].restrict == true) {
       BixbyMD.send5ButImg(pea[0].id, `*GROUP SETTING CHANGED*\n\n🚀. Group Info Has Been Restricted, Now Only Admin Can Edit Group Info !`, `ʏᴏꜱʜɪᴛʜᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`, lolXeon, [])
       } else if (pea[0].restrict == false) {
       BixbyMD.send5ButImg(pea[0].id, `*GROUP SETTING CHANGED*\n\n🚀. Group Info Has Been Opened, Now Participants Can Edit Group Info !`, `ʏᴏꜱʜɪᴛʜᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`, lolXeon, [])
       } else {
       BixbyMD.send5ButImg(pea[0].id, `*GROUP SETTING CHANGED*\n\n🚀. Group Subject Has Been Changed To *${pea[0].subject}*`, `ʏᴏꜱʜɪᴛʜᴀ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`, lolXeon, [])
     }
    })
